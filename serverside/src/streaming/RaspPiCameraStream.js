...
module.exports.startJSmpegStream = function startStream(){
    p = processFfmpeg.exec(`ffmpeg -f v4l2 -framerate 30 -video_size 640x480 -i /dev/video0 -f mpegts -codec:v mpeg1video -s 640x480 -b:v 1000k -bf 0 http://localhost:5555/endpointFFmpegRaspPiCam `)
    console.log(p.pid)
}
